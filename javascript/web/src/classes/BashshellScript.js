...
export default class BashshellScript {

    constructor( target_dir ) {
        return `
export FIRST_BRAIN="TARGET_DIRECTORY_TOKEN/first"
export SECOND_BRAIN="TARGET_DIRECTORY_TOKEN/second"

export QUEUE_PATH="TARGET_DIRECTORY_TOKEN/queue"
export NOTES_PATH="TARGET_DIRECTORY_TOKEN/notes"
export STATISTICS_PATH="TARGET_DIRECTORY_TOKEN/statistics"
